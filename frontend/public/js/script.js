...
const GOOGLE_SHEETS_WEBHOOK =
    "https://script.google.com/macros/s/AKfycbxvZzrSMm1BaivIH4tG1xpPBxOmRz91q4kh7AZwJXfxFgkS7PGmeLZCXs1ptq5cHssK/exec";
...
const DEFAULT_FAQ = [
    {
        id: "faq-1",
        question: "What is Alpha Q7 Trading Institute?",
        answer: "Alpha Q7 is a trading education institute focused on market knowledge, trading strategies, technical analysis, discipline, and responsible risk management."
    },
    {
        id: "faq-2",
        question: "What will I learn at Alpha Q7?",
        answer: "You’ll learn market analysis, trading strategies, risk management, trading psychology, and practical decision-making."
    },
    {
        id: "faq-3",
        question: "Does Alpha Q7 guarantee profits?",
        answer: "No. We do not promise guaranteed profits. Our focus is on education, strategy, discipline, and responsible risk management. Trading involves financial risk."
    },
    {
        id: "faq-why",
        question: "WHY ALPHA Q7?",
        answer: "We’re not here to tell you trading is easy, promise guaranteed profits, or sell a “magic strategy.” We’re here to help you understand the markets, identify opportunities, manage risk, and build the confidence to make independent trading decisions."
    },
    {
        id: "faq-4",
        question: "Do I need prior trading experience?",
        answer: "No. Our learning approach is suitable for beginners and also helps experienced traders refine their strategies and decision-making."
    },
    {
        id: "faq-5",
        question: "Is the training practical or theoretical?",
        answer: "We combine market concepts with practical analysis and real-world trading scenarios to help you develop a structured approach to trading."
    },
    {
        id: "faq-6",
        question: "How can I join Alpha Q7?",
        answer: "Simply get in touch with our team to learn more about our programs, training options, schedules, and enrollment process."
    }
];
    ...
    getCourses().forEach(course => {
        ...
        card.innerHTML = `
            <div
                ...
                role="button"
                tabindex="0"
                aria-label="Open ${escapeHtml(course.title)} course information"
            >
        ...
        const summary =
            card.querySelector(".course-summary");

        const toggle =
            card.querySelector(".course-toggle");
...
let previousCourseModalFocus = null;
...
function createCourseDetailsModal() {
    ...
    modal.innerHTML = `
        ...
        <div
            class="course-details-modal-overlay"
            data-course-modal-close
        ></div>


        <div
            class="course-details-modal-card"
            role="dialog"
            aria-modal="true"
            aria-labelledby="courseDetailsTitle"
        >
            ...
            <div class="course-details-header">
                ...
                <div
                    class="course-details-icon"
                    id="courseDetailsIcon"
                ></div>
                ...
                <div class="course-details-heading">
                    ...
                    <span>
                        ALPHA Q7 TRADING PROGRAM
                    </span>

                    <h2
                        id="courseDetailsTitle"
                    ></h2>

                    <p
                        id="courseDetailsSubtitle"
                    ></p>
            ...
            <div class="course-details-divider"></div>
            ...
            <div class="course-details-body">
                ...
                <section class="course-details-section">
                    ...
                    <h3
                        id="courseDetailsWhatTitle"
                    >
                    </h3>

                    <p
                        id="courseDetailsWhat"
                    >
                    </p>
                ...
                <section class="course-details-section">
                    ...
                    <div
                        class="course-details-benefits"
                        id="courseDetailsBenefits"
                    ></div>
            ...
            <div class="course-details-footer">
                ...
                <a
                    id="courseDetailsLearnMore"
                    class="course-details-learn-more"
                    href="#"
                >
                    LEARN MORE
                    <span>→</span>
     ...
     * VERY IMPORTANT
     *
     * The modal is appended directly to BODY.
     * Therefore it cannot push the footer down.
     */
...
function openCourseDetailsModal(
    ...
    (
        ...
        benefit => {
            ...
            benefitElement.append(
                check,
                text
            );


            benefitsContainer.appendChild(
                benefitElement
            );
...
function closeCourseDetailsModal() {
    ...
    window.setTimeout(
        () => {
            ...
            if (
                previousCourseModalFocus &&
                typeof previousCourseModalFocus.focus ===
                    "function"
            ) {

                previousCourseModalFocus.focus();
...
function renderFAQ() {
    ...
    /*
     * Fixed public FAQ content.
     * Layout:
     *   TOP/CENTER: WHY ALPHA Q7?
     *   LEFT:       3 questions
     *   RIGHT:      3 questions
     */
    const faqItems = [
    ...
    center.className = "faq-center-wrap";

    const left = document.createElement("div");
    left.className = "faq-column faq-column-left";

    const right = document.createElement("div");
    right.className = "faq-column faq-column-right";

    function createFAQItem(item, isCenter = false) {
        const element = document.createElement("details");
        element.className = "faq-item";

        if (isCenter) {
            element.classList.add("faq-center");
        }
        ...
        summary.append(questionText, icon);

        const answer = document.createElement("div");
        answer.className = "faq-answer";
        answer.textContent = item.answer;

        element.append(summary, answer);

        /*
         * True accordion behavior:
         * opening one FAQ closes every other FAQ.
         */
        element.addEventListener("toggle", () => {
            ...
            icon.textContent = element.open ? "−" : "+";
        });

        return element;
    }

    /* WHY ALPHA Q7 is always the first/top item. */
    center.appendChild(createFAQItem(faqItems[3], true));

    /* Three independent questions on the left. */
    faqItems.slice(0, 3).forEach(item => {
        left.appendChild(createFAQItem(item));
    });

    /* Three independent questions on the right. */
    faqItems.slice(4, 7).forEach(item => {
        right.appendChild(createFAQItem(item));
    });

    container.append(center, left, right);
}
const leadForm =
    $("#leadForm");
